...
[![codecov](https://codecov.io/gh/alohays/content-ai-research-template/branch/main/graph/badge.svg?token=content-ai-research-template_token_here)](https://codecov.io/gh/alohays/content-ai-research-template)
...
```bash
pip install content_ai_research_template
```
